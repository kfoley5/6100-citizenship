...
//     Vis 2               //
        ...
        d3.select("#marriage").on("click", function () {
            ...
            svg.append("line")
                ...
                .transition()
                .duration(800)
                .attr("x2", width / 2 - 319.4)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 - 314.4)
                .attr("x2", width / 2 - 314.4)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(800)
                .duration(800)
                .attr("x2", width / 2 - 213.8)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 - 208.8)
                .attr("x2", width / 2 - 208.8)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(1600)
                .duration(800)
                .attr("x2", width / 2 - 108.2)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 - 103.2)
                .attr("x2", width / 2 - 103.2)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(2400)
                .duration(800)
                .attr("x2", width / 2 - 2.06)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 + 2.94)
                .attr("x2", width / 2 + 2.94)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(3200)
                .duration(800)
                .attr("x2", width / 2 + 103.5)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 + 108.5)
                .attr("x2", width / 2 + 108.5)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(4000)
                .duration(800)
                .attr("x2", width / 2 + 209.1)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 + 214.1)
                .attr("x2", width / 2 + 214.1)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(4800)
                .duration(800)
                .attr("x2", width / 2 + 314.7)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 + 319.7)
                .attr("x2", width / 2 + 319.7)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
        ...
        d3.select("#residency").on("click", function () {
            ...
            svg.append("line")
                ...
                .transition()
                .duration(800)
                .attr("x2", width / 2 - 304.3)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 - 299.3)
                .attr("x2", width / 2 - 299.3)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(800)
                .duration(800)
                .attr("x2", width / 2 - 183.6)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 - 178.6)
                .attr("x2", width / 2 - 178.6)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(1600)
                .duration(800)
                .attr("x2", width / 2 - 62.9)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 - 57.9)
                .attr("x2", width / 2 - 57.9)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(2400)
                .duration(800)
                .attr("x2", width / 2 + 57.8)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 + 62.8)
                .attr("x2", width / 2 + 62.8)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(3200)
                .duration(800)
                .attr("x2", width / 2 + 178.5)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 + 183.5)
                .attr("x2", width / 2 + 183.5)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
                ...
                .delay(4000)
                .duration(800)
                .attr("x2", width / 2 + 299.2)
                .attr("y2", height / 2 + 100);

            svg.append("line")
                .attr("x1", width / 2 + 304.2)
                .attr("x2", width / 2 + 304.2)
                .attr("y1", height / 2 + 100)
                .attr("y2", height / 2 + 100)
                .attr("stroke", "rgb(255,255,255,.5)")
                .attr("stroke-width", 15)
